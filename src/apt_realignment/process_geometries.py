...
class ProcessGeometricData:
    ...
    def process_dataframe(self, bfp_count_per_parcel=1):
        ...
        bfp_intersection_parcel_df['updated_geometries'] = bfp_intersection_parcel_df['building_roi'].parallel_apply(
            lambda x: x.centroid)
        ...
        if self.debug:
            ...
            processed_df['APT_to_Centroid_distance'] = processed_df.apply(lambda x: self.get_apt_to_bfp_distance(x),axis=1)
